-- ===================================================================
-- 경고: 이 스크립트는 M_emotion와 emotion_category 테이블의 모든 데이터를 삭제합니다.
-- ===================================================================

-- 외래 키 제약 조건을 잠시 비활성화합니다.
-- (데이터 삭제 시 순서에 상관없이 처리할 수 있어 편리합니다.)
SET FOREIGN_KEY_CHECKS = 0;

-- 1. 테이블의 모든 데이터를 빠르고 깨끗하게 삭제합니다.
-- TRUNCATE는 DELETE보다 효율적이며, AUTO_INCREMENT 값도 1로 초기화합니다.
TRUNCATE TABLE M_emotion;
TRUNCATE TABLE emotion_category;
...
-- (emotion_category_id는 위 INSERT 순서에 따라 1부터 자동 증가된다고 가정)
